 ...
 */
export async function getProjectSettingsCached(db: admin.firestore.Firestore): Promise<any> {
  const now = Date.now();
 ...
 */
export async function markPeriodDirty(db: admin.firestore.Firestore, yearMonth: string): Promise<void> {
