...
exports.extractContractEffectiveDate = extractContractEffectiveDate;
exports.compareContractEffectiveDates = compareContractEffectiveDates;
 ...
 */
function extractContractEffectiveDate(cData) {
    const orig = cData?.original || {};
    const edits = cData?.edits || {};
    return (cData?.startDate ||
        cData?.createdAt ||
        edits?.createdAt ||
        orig?.startDate ||
        orig?.createdAt ||
 ...
 */
function compareContractEffectiveDates(a, b) {
