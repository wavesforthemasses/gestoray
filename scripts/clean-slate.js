...
function resetActiveWorkspace() {
  ...
  fs.writeFileSync(path.join(autoGenDir, 'generated_menu.ts'), `// ⚠️ AUTO-GENERATED BY GESTORAY MODULE INSTALLER CLI - DO NOT TOUCH DIRECTLY!\nimport type { MenuItemConfig } from '$lib/stores/menu';\n\nexport const MODULE_MENU_SNIPPETS: MenuItemConfig[] = [];\n`, 'utf-8');
  fs.writeFileSync(path.join(autoGenDir, 'generated_roles.ts'), `// ⚠️ AUTO-GENERATED BY GESTORAY MODULE INSTALLER CLI - DO NOT TOUCH DIRECTLY!\nexport const MODULE_ROLES_SNIPPETS: any[] = [];\n`, 'utf-8');
  fs.writeFileSync(path.join(autoGenDir, 'generated_features.ts'), `// ⚠️ AUTO-GENERATED BY GESTORAY MODULE INSTALLER CLI - DO NOT TOUCH DIRECTLY!\nexport const MODULE_FEATURE_SNIPPETS: Record<string, any> = {};\n`, 'utf-8');
