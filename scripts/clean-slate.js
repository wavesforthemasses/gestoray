...
function resetActiveWorkspace() {
  ...
  // 7. Reset auto_generated config files
  fs.mkdirSync(autoGenDir, { recursive: true });
  fs.writeFileSync(path.join(autoGenDir, 'generated_menu.ts'), `// ⚠️ AUTO-GENERATED BY MODULE INSTALLER CLI - DO NOT TOUCH DIRECTLY!\nimport type { MenuItemConfig } from '$lib/stores/menu';\n\nexport const MODULE_MENU_SNIPPETS: MenuItemConfig[] = [];\n`, 'utf-8');
  fs.writeFileSync(path.join(autoGenDir, 'generated_roles.ts'), `// ⚠️ AUTO-GENERATED BY MODULE INSTALLER CLI - DO NOT TOUCH DIRECTLY!\nexport const MODULE_ROLES_SNIPPETS: any[] = [];\n`, 'utf-8');
  fs.writeFileSync(path.join(autoGenDir, 'generated_features.ts'), `// ⚠️ AUTO-GENERATED BY MODULE INSTALLER CLI - DO NOT TOUCH DIRECTLY!\nexport const MODULE_FEATURE_SNIPPETS: Record<string, any> = {};\n`, 'utf-8');
  console.log(`  ✅ Ripristinati registri auto-generati in src/lib/config/auto_generated/`);

  // 8. Reset firestore.indexes.json to Clean Base Core
  const cleanIndexes = {
    indexes: [
      {
