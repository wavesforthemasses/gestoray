<script lang="ts">
  ...
  import ContractProductsList from '../components/ContractProductsList.svelte';
  import ContractSignatures from '../components/ContractSignatures.svelte';
  import ContractInstallments from '../components/ContractInstallments.svelte';
