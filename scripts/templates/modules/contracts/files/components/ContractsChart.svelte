    ...
    <Card title="Andamento Contratti e Provvigioni" description="Visualizza il trend e clicca su un punto del grafico per filtrare l'elenco dei contratti in base al periodo selezionato.">
      ...
      <div class="chart-controls-box controls-layout">
        <div class="chart-tab-switcher tab-switcher-bg">
          <button class="chart-tab-btn tab-btn-style" class:active={activeChartTab === 'vss'} onclick={() => { activeChartTab = 'vss'; onPointSelect(null); }} title="Valore Venduto (VSS)">VSS</button>
          <button class="chart-tab-btn tab-btn-style" class:active={activeChartTab === 'provvigioni_maturate'} onclick={() => { activeChartTab = 'provvigioni_maturate'; onPointSelect(null); }} title="Provvigioni Maturate">PM</button>
        </div>
