...
<div class="add-activity-page animate-fade-in">
  <div class="page-top">
    ...
    <h2>
      <Pencil size={22} class="header-icon" /> Modifica Attività Operativa
    </h2>
  </div>
  ...
  {:else if !activity}
    <div class="alert error-box">
      <AlertCircle size={16} /> Attività non trovata o eliminata.
    </div>
  {:else}
    {#if errorMsg}
      <div class="alert error-box">
    ...
    <form onsubmit={handleSubmit} class="activity-form">
      ...
      <div class="form-actions-bar">
        ...
        <button type="submit" class="btn-submit" disabled={saving}>
          <Save size={16} /> {saving ? 'Salvataggio...' : 'Aggiorna Attività'}
        </button>
      </div>
    </form>
  {/if}
