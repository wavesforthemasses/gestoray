...
| **Units of Measure Service** | [src/lib/services/unitsOfMeasureService.ts](file:///home/vincenzo/Code/gestoray/src/lib/services/unitsOfMeasureService.ts) | `UnitsOfMeasureService` | Centralized catalog for Units of Measure (mc, mq, pz, kg, l, ora) & CSV import alias resolution. |
